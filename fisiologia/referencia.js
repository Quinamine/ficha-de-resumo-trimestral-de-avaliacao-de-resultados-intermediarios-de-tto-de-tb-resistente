...
const referencia = {
    retornarLinhaEcoluna(inputTarget) {
        ...
        const indicadoresColunares = document.querySelectorAll(".seccao-1__header__linha-de-indicadores-colunares span");
        ...
        for(let i=0; i < inputTargetAndSiblings.length; i++)  {
            if(inputTargetAndSiblings[i] === inputTarget) inputTargetColIndex = i;
        }
